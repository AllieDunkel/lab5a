...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    theProduct = multiply(c, theProduct)[0];
    return [theSum, theProduct, `${a} and ${b} and ${c} sum to ${theSum}.`,
     `The product of ${a} and ${b} and ${c} is ${theProduct}.`];
...
Write a function called sumArray() that takes in an array of numbers as its single argument and
 then returns an array where the first element is the sum of the numbers in the array, and the
  second element is a string that EXACTLY follows this example and uses the values that were input
   into the function:

"2,3,4 was passed in as an array of numbers, and 9 is their sum."

IMPORTANT DETAIL: You may not use the arithmetic operator + in this function. To do addition, use
 your sum() function that you've already created. You're going to have to be resourceful to figure
...
// Write your code here
//'2,3,4 was passed in as an array of numbers, and 9 is their sum.'
//'2,3,4 was passed in an array of numbers, and 9 is their sum.'
/**
 * 
 * @param {numbers} sumArr
...
function sumArray(sumArr) { //eslint-disable-line
  ...
  for (let index = 0; index < sumArr.length; index++) {
    ...
    numberString+= comma +sumArr[index];
    comma = ",";
...
returns an array whose first element is the product of those numbers, and the second element
 is a string that EXACTLY follows this example and uses the values that were input into the
  function:

"The numbers 2,3,4 have a product of 24."

//The numbers 3,3,3 have a product of 27.
//The numbers 2,3,4 have a product of 24.
...
for (let index = 0; index < multArr.length; index++) {
  ...
  numberString+= comma +multArr[index];
  comma = ",";
}
return[total, `The numbers ${numberString} have a product of ${total}.`]
}
